...
public class HumorArticle {
    ...
    @Builder
    public HumorArticle(Long id, String title, String content, String email, LocalDateTime createDate, LocalDateTime updateDate, String deleteYn, int viewCount, String boardCode, MemberInfo memberInfo) {
        this.id = id;
        this.title = title;
